...
class HibernateAccidentRepositoryTest {
     ...
     */
    @Autowired
    private HibernateAccidentRepository accidentStore;
    ...
    void whenDeleteAccidentThenDBStoreHasNotSameAccident() {
        ...
        assertTrue(accidentStore.findById(accidentInDB.getId()).isEmpty());
    }
    ...
    void whenFindAccidentByIdThenGetItFromDBStoreOrGetEmptyResultDataAccessException() {
        ...
        assertTrue(accidentStore.findById(1000).isEmpty());
    }
    ...
    void whenDeleteAllArchivedAccidentsThenDBStoreHasNotSameAccidents() {
        ...
        assertTrue(accidentStore.findById(archivedAccidentsInDB.get(0).getId()).isEmpty());
        assertTrue(accidentStore.findById(archivedAccidentsInDB.get(1).getId()).isEmpty());
    ...
    void whenFindAllAccidentsByAddressAndDateRangeThenGetThemFromDBStore() {
        ...
        LocalDateTime after = before.minusDays(3L);
        List<Accident> filtered =
                accidentStore.findAllByAddressAndDateRange(address, after, before);
        assertThat(filtered.size()).isEqualTo(2);
        assertThat(filtered.get(0).getName()).isEqualTo("name1");
        assertThat(filtered.get(1).getName()).isEqualTo("name4");
    }
     ...
     */
    @Test
    void whenFindAllAccidentsByCarPlateThenGetThemFromDBStore() {
